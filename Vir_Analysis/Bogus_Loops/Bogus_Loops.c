...
enum _1_sum_$op {
    _1_sum__PlusA_int_int2int$left_STA_0$result_STA_0$right_STA_1 = 103,
    _1_sum__store_int$left_STA_0$right_STA_1 = 100,
    _1_sum__load_int$left_STA_0$result_STA_0 = 252,
    _1_sum__goto$label_LAB_0 = 1,
    _1_sum__return_int$expr_STA_0 = 90,
    _1_sum__formal$result_STA_0$value_LIT_0 = 3,
    _1_sum__local$result_STA_0$value_LIT_0 = 91
} ;
...
{ 
  ...
  while (1) {
    randomFuns_body_i11 = 0;
    while (randomFuns_body_i11 < 2) {
      _1_sum__alwaysOne = 1;
      randomFuns_body_i11 ++;
    }
    switch (*(_1_sum_$pc[0])) {
    case _1_sum__local$result_STA_0$value_LIT_0: 
    _1_sum_$pc[0] += _1_sum__alwaysOne;
