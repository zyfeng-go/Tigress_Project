...
{ 
  ...
  while (1) {
    ...
    if (_1_sum_$currentOp == _1_sum__local$result_STA_0$value_LIT_0) {
      (_1_sum_$pc[0]) ++;
      (_1_sum_$sp[0] + 1)->_void_star = (void *)(_1_sum_$locals + *((int *)_1_sum_$pc[0]));
      (_1_sum_$sp[0]) ++;
      _1_sum_$pc[0] += 4;
    } else
    if (_1_sum_$currentOp == _1_sum__load_int$left_STA_0$result_STA_0) {
      (_1_sum_$pc[0]) ++;
      (_1_sum_$sp[0] + 0)->_int = *((int *)(_1_sum_$sp[0] + 0)->_void_star);
    } else
    if (_1_sum_$currentOp == _1_sum__store_int$left_STA_0$right_STA_1) {
      (_1_sum_$pc[0]) ++;
      *((int *)(_1_sum_$sp[0] + 0)->_void_star) = (_1_sum_$sp[0] + -1)->_int;
      _1_sum_$sp[0] += -2;
    } else
    if (_1_sum_$currentOp == _1_sum__formal$result_STA_0$value_LIT_0) {
      (_1_sum_$pc[0]) ++;
    ...
    if (_1_sum_$currentOp == _1_sum__PlusA_int_int2int$left_STA_0$result_STA_0$right_STA_1) {
      (_1_sum_$pc[0]) ++;
      (_1_sum_$sp[0] + -1)->_int = (_1_sum_$sp[0] + 0)->_int + (_1_sum_$sp[0] + -1)->_int;
      (_1_sum_$sp[0]) --;
    } else
    if (_1_sum_$currentOp == _1_sum__return_int$expr_STA_0) {
      (_1_sum_$pc[0]) ++;
      return ((_1_sum_$sp[0] + 0)->_int);
    } else
    if (_1_sum_$currentOp == _1_sum__goto$label_LAB_0) {
      (_1_sum_$pc[0]) ++;
